...
Também não havia espaço para a canção passional, considerada ``cafona'', ou ``brega'', como passou a ser chamada mais tarde, e tão ``alienada''
...
Em \textit{Beleléu}, o ``eu'' do compositor e intérprete Itamar Assumpção ganhou
...
\begin{bibliohedra}
\tit{Assumpção}, Itamar. \textit{Pretobrás: Porque que eu não pensei nisso antes?}, vol.
...
Além disso, está presente nos anais do \textsc{iv} Congresso \textsc{abralic} (Associação Brasileira de Literatura Comparada): Literatura e Diferença, São Paulo, agosto de 1994.}}
...
\chapter{Vocação e perplexidade dos cancionistas\footnote{Publicado pela primeira vez no jornal \textit{Folha de S.Paulo}, ``Folhetim'', em 20 de fevereiro de 1983, ``Vocação e perplexidade dos
...
\chapter{Cancionistas invisíveis\footnote{Transcrevemos aqui o ensaio ``Cancionistas invisíveis'', originalmente escrito para a \textit{Revista Cult}, n.\,105, ano 9, em 2006, e parte do livro \textit{Todos entoam: ensaios, conversas e canções}.}}
