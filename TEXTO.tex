...
%\emph{O século \textsc{xx} em foco}

%\emph{A dicção do Cancionista}}
...
\chapter{O século \textsc{xx} em foco\footnote{\textit{O século \textsc{xx} em foco}. O século da canção, Cotia: Ateliê Editorial, 2004.\\
O livro O século da Canção é um estudo de Luiz Tatit
sobre a canção popular produzida no Brasil em todo o século \textsc{xx}. Em O
Século \textsc{xx} em Foco, Tatit propõe uma análise do século através de grandes
...
(Vicente Celestino), incluída no \textsc{lp} Tropicália, até o sucesso retumbante
...
\item Cf. artigo de Walnice N. Galvão, \textsc{mmpb}: uma análise ideológica,
...
\item Djavan/Guilherme Arantes. Itamar Assumpção/Grupo Rumo.
...
passagem deste último acorde ao seguinte (\textsc{sol}m7), adquire uma função ao
mesmo tempo ativa e retroativa. Ativa porque exerce forte tensão sobre
as principais notas que caracterizavam o acorde de \textsc{sol}m: a fundamental e
...
(como se fosse um RÉ7(9) preparando um \textsc{sol}7(13)).
