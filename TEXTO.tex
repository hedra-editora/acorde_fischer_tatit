...
passado --- saudades, lembranças et. --- como sobre o futuro --- esperanças,
...
a todos os representantes da \textsc{mpb} sediados à época na rede \textit{Record} de São
...
\chapter{Cancionistas invisíveis\footnote{Transcrevemos aqui o ensaio ``Cancionistas invisíveis'', originalmente escrito para a \textit{Revista Cult}, em 2006, e parte do livro \textit{Todos entoam: ensaios, conversas e canções}}.
...
correntes se abrigavam na mesma casa, a \textit{\textsc{tv} Record}, e portanto eram
...
sintonizar o televisor na \textit{Record} ou o rádio na emissora do mesmo grupo.
