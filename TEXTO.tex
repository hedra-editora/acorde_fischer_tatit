...
\emph{O século XX em foco}

\href{https://pt.scribd.com/doc/244017320/Diccao-do-cancionista-Luiz-Tatit-pdf}{\emph{A
dicção do Cancionista}}

\emph{Dicção de Tom Jobim}

\emph{A Transmutação do Artista}

\emph{O Momento de Criação na Canção Popular}

\emph{Vocação e Perplexidade dos Cancionistas}

\emph{Cancionistas Invisíveis }

\textbf{O século XX em foco}

\emph{O século XX em foco}. O século da canção, Cotia: Ateliê Editorial,
2004.

\textbf{Nota:} O livro O século da Canção é um estudo de Luiz Tatit
...
\textbf{Expansão dos gestos bossa-nova e tropicalista}
...
1 - É evidente que os próprios compositores e músicos de modo geral
...
2 - Como essas ocorrências são cíclicas, vez por outra revivemos
...
3 - Cf. artigo de Walnice N. Galvão, MMPB: uma análise ideológica,
...
\textbf{Dicção do Cancionista}

\emph{Dicção do Cancionista}. O cancionista: composição de canções no
Brasil. 2º edição. São Paulo: Editora da Universidade de São Paulo,
2002.

\textbf{Nota:} transcrevemos o primeiro capítulo do livro O Cancionista:
...
a) não há modelo único de fala. Há falas que expressão sentimentos
...
b) a fala pura é, em geral, instável, irregular e descartável no que
...
c) esse sentido de ordenação obriga o compositor a procurar outras
...
d) qualquer seja o projeto de cação escolhido, e por mais que a melodia
...
\textbf{*} As modinhas de salão, escritas em partituras, contemporâneas
dos sambas-maxixes de quintal em que se improvisavam melodias e versos.

* Serestas e tangos interpretados pelo vozeirão de Vicente Celestino.
...
*Chico Alves ligando as vogais. Mário Reis recortando as sílabas.~

*Araci de Almeida com canções chorosas. Carmem Miranda com entoações
alegres, às vezes caricaturais, perfazendo da fala ao canto e do canto à
fala um curso contínuo.

*Composição de piano. Composição de violão.

*Intensidade: Jamelão, Ângela Maria, Caubi Peixoto, Anísio Silva.
Densidade: Dick Farney, Lúcio Alves, Pianíssimo e despojamento: João
Gilberto.

*Elis Regina cantando Zambi. Roberto Carlos, Não Quero Ver Você Triste.

*Disparada. A Banda.

*Tim Maia. Jorge Ben Jor.

*Caetano Veloso com Tigresa ou Queixa. Caetano com Da Maior Importância
ou Ele Me Deu um Beijo na Boca. Interpretando Sina. Interpretando
Sonhos.

*London London, versão RPM. Você não soube me amar pela Blitz.

*Djavan/Guilherme Arantes. Itamar Assumpção/Grupo Rumo.

*Rocks. Raps;

f) os compositores transformam-se naturalmente em cantores. Afinal, a
...
\textbf{Tensões Passionais e Tensões Temáticas}
...
a) em sua penetração do universo da canção popular por uma via própria
de sua linguagem, o que contribui para resolver o famoso impasse: "por
onde começar?";

b) na identificação dos traços específicos do autor e da obra em
...
a) o nível da arquicanção, situado na interseção das canções, que contém
...
b) o nível das canções propriamente ditas, em que se verifica a
originalidade das soluções adotadas pelos autores em cada uma das obras;

c) o nível dos efeitos de sentido captados na audição, mas indefinidos
...
\item
  \begin{quote}
  Barros (1988), Courtês (1979), Fioria (1989), Greimas \& Courtês
  (s.d.).
  \end{quote}
\end{itemize}

\textbf{Dicção de Tom Jobim}

\emph{Dicção de Tom Jobim}. O cancionista: composição de canções no
Brasil. 2º edição. São Paulo: Editora da Universidade de São Paulo,
2002.

\textbf{Nota:} transcrevemos o capítulo que analisa a obra de Tom Jobim,
...
\textbf{Acordes: engate e desengate}
...
enunciador em estado de conjunção com os valores visuais;
...
\textbf{A Transmutação do Artista~}

\emph{A Transmutação do Artista}. Todos Entoam: ensaios, conversas e
canções, São Paulo: Publifolha, 2007.

\textbf{Nota:} O livro Todos Entoam conta com 16 ensaios sobre a canção
...
\textbf{A Enunciação do Cancionista}
...
\textbf{Sampa Midnight: Isso não vai ficar assim}
...
\textbf{Intercontinental Quem diria! Era só o que faltava!!!}
...
Não cessaram, porém, os pronunciamentos em forma de manifesto cri-
...
\textbf{O momento de criação na canção popular}

\emph{O momento de criação na canção popular}. Todos Entoam: ensaios,
...
As letras que mais admiramos foram geradas a partir de fragmentos in-
...
\textbf{Vocação e Perplexidade dos Cancionistas}

\emph{Vocação e Perplexidade dos Cancionistas}. Todos Entoam: ensaios,
conversas e canções, São Paulo: publifolha, 2007.
...
\textbf{Configurando a prática do cancionista}
...
\textbf{Sujeitos insubstituíveis~}
...
\textbf{Cancionistas Invisíveis}

\emph{Cancionistas Invisíveis}. Todos Entoam: ensaios, conversas e
canções, São Paulo: publifolha, 2007.
