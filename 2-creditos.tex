...
\textbf{organização©}\quad			 		 {Luís Augusto Fischer}\\
%\textbf{agradecimentos}\quad			 	 {agradecimentos}\\

\textbf{edição}\quad			 			 {Paulo Almeida e Janaína Marquesini}\\
\textbf{coedição}\quad			 			 {Jorge Sallum e Suzana Salama}\\
\textbf{assistência editorial}\quad			 {Paulo Henrique Pompermaier}\\
\textbf{revisão}\quad			 			 {Renier Silva}\\
\textbf{capa}\quad			 				 {Lucas Kröeff}\\

\textbf{\textsc{isbn}}\quad			 		 {978-65-99441-29-5}
